...
export class userAddWallet1667938476397 implements MigrationInterface {
    name = 'userAddWallet1667938476397'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_922e8c1d396025973ec81e2a402" FOREIGN KEY ("walletId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

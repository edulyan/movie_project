...
export class moviePersonEntities1664609620379 implements MigrationInterface {
    name = 'moviePersonEntities1664609620379'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movies_persons" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "movieId" uuid NOT NULL, "personId" uuid NOT NULL, "type" "public"."movies_persons_type_enum" array NOT NULL, CONSTRAINT "PK_6a65f90523676a3d164292d6896" PRIMARY KEY ("id"))`);
